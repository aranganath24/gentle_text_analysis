...
setwd("019.11.14-ElDiarioCorpus/adverts")
```
...
```{r, echo=-1}
setwd("2019.11.14-ElDiarioCorpus/adverts")
...
```{r, eval=F}
# Prints the contents of "diario_adverts_tidy"
diario_adverts_tidy
```
...
diario_frequency_table<-
  diario_adverts_tidy %>% # declares dataset with relevant text
