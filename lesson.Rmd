...
* Finally, we assigneed the plot created by this code to a new object named ```diario_frequency_graph```.
...
Take a look at the various arguments to ```wordcloud2()```, and explore manipulating some of those arguments to try and customize the appearance of the wordcloud we created above. 
...
```{r}
# Extracts a new data frame of the ten most frequently occurring bigrams in 
