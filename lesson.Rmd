...
# reads in the filenames for diario advertisements as a character vector, and 
...
# "diario_adverts_corpus" corpus into a tidy data frame, where each file's 
# textual information is stored as a row in the data frame; this data frame is 
# assigned to a new object named "diario_adverts_tidy"
...
# dataset (organized in descending order) 
...
# "diario_frequency_table" and assigns it to a new object named 
...
```{r}
# extracts all rows in which the "diario_frequency_table_numbers" column of the 
...
# a new object named "business_keyword_context"
